  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pb-safe">
      <div className="mx-auto max-w-md px-6 pb-6">
        <nav className="relative flex h-[4.5rem] items-center justify-around rounded-[2.5rem] border border-white/20 bg-background/60 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.4)] px-2">
          {tabs.map((tab) => (
            <NavTab
              key={tab.id}
              id={tab.id}
