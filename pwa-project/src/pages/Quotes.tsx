          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              ...
              <button 
                ...
                className="h-8 w-8 flex items-center justify-center text-primary/40 hover:text-primary hover:bg-primary/10 rounded-lg transition-all"
              >
              ...
              >
                ...
                <div className="flex items-center justify-between mt-auto pt-4 relative z-10 border-t border-border/40">
                  <div className="flex flex-col">
                    ...
                    {quote.source && (
                      <span className="text-xs text-muted-foreground font-medium mt-0.5">{quote.source}</span>
                    )}
                  </div>
