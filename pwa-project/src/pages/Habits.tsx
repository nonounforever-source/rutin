                ...
                >
                  ...
                  <div className="flex items-center gap-3 mr-2">
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 transition-opacity p-2.5 text-destructive/40 hover:text-destructive hover:bg-destructive/10 rounded-2xl"
                    >
                      <Trash2 size={18} />
                    </button>
                    ...
                    {habit.type === 'checkbox' ? (
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="w-10 h-10 rounded-full bg-secondary/40 flex items-center justify-center text-muted-foreground/40 group-hover:text-primary transition-colors">
                          <ChevronLeft size={22} />
                        </div>
                      </div>
                    )}
              ...
              <div className="p-6 pt-2 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-[11px] font-black text-muted-foreground/60 mb-1 block uppercase tracking-[0.15em] ml-4">الفئة والأيقونة</label>
