      ...
      {totalCount > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <motion.div 
            ...
            className="md:col-span-2 ios-card p-6 flex flex-col justify-between bg-gradient-to-br from-card to-secondary/30"
          >
...
function GoalEditor({ initialData, onClose, onSave }: { 
  ...
  return (
    <motion.div 
      ...
      className="bg-secondary/30 backdrop-blur-xl w-full max-w-lg rounded-t-[2rem] sm:rounded-[2rem] shadow-2xl overflow-hidden border border-border/50 flex flex-col relative z-10 max-h-[90vh]"
      ...
      <div className="p-6 pt-0 overflow-y-auto space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card rounded-2xl overflow-hidden border border-border/50 p-4">
            <label className="text-sm font-semibold text-muted-foreground mb-3 block">تصنيف الهدف</label>
